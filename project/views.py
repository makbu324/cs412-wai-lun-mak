...
def search_songs(request):
    ...
    return render( request, "project/search_songs.html", {'lyrics': contents_baby, "artist_name" : artist_name, "chords": CHORDS, "song_name": song_name, "chords_info": chords_info, "song_info": song_info, "the_artist_image": the_artist_image, "url_stuff": url_stuff, "url_link": url_link, "spotify_url": spotify_url, "item": Item(video=yt_url), "capo_stuff": capo_info, "ver": ver, "status": stat})
...
class ShowSong(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["chords"] = chs
        context["item"] = Item(video=song.vimeo_link) 
